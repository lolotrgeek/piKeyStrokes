...
# Mouse 2
MOUSE_2_FUNCTIONS_DIR="functions/hid.MOUSE_2"
mkdir -p "$MOUSE_2_FUNCTIONS_DIR"
echo 0 > "${MOUSE_2_FUNCTIONS_DIR}/protocol"
echo 0 > "${MOUSE_2_FUNCTIONS_DIR}/subclass"
echo 4 > "${MOUSE_2_FUNCTIONS_DIR}/report_length"
# Write the report descriptor
...
echo -ne \\x81\\x06 >> "$D"      #    INPUT (Data,Var,Rel)
echo -ne \\xC0 >> "$D"           #  END_COLLECTION
cp "$D" "${MOUSE_2_FUNCTIONS_DIR}/report_desc"
...
ln -s "$MOUSE_2_FUNCTIONS_DIR" "${CONFIGS_DIR}/"
